...
public class Controle {
    ...
    public String PostHome(
        ...
        System.out.println("bid recebido:" + bid);
        System.out.println("date recebido:" + date);
        ...
        if(date != null){
            ...
            data = hoje.get(Calendar.YEAR)+"-" + (hoje.get(Calendar.MONTH) + 1) + "-" +hoje.get(Calendar.DAY_OF_MONTH); // yes ISO
            //String data = (hoje.get(Calendar.DAY_OF_MONTH) + "-" + (hoje.get(Calendar.MONTH) + 1) + "-" + hoje.get(Calendar.YEAR)); // not ISO
